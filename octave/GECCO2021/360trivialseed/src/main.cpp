...
unsigned int maxSize=50; // Minimum size for Random Initialisation.
...
int main(int argc, char **argv){
    ...
    system("rm -rf ./tmp/* && mkdir -p ./tmp && cp ./data/* tmp/" );
    ...
    params.set(gaNpCrossover,0.7); // Probability of crossover.
    params.set(gaNpMutation,0.3); // Probability of mutation.
