...
meanFit_plot1 <- colMeans(meanFit)
...
maxFit <- maxFit[2:31,]
maxFit_plot2 <- apply(maxFit, 2, function(x) max(x))

meanFit <- meanFit[2:31,]
meanFit_plot2 <- colMeans(meanFit)
...
setwd("~/LIBGE/libge-examples-master/verilog/mul4_vector_tournament/Past Runs/runs_last_50/")
files <- list.files(pattern="output*")
distances <- list.files(pattern="edit_distance*")
wd <- getwd() 
...
maxFit <- maxFit[2:31,]
maxFit_plot3 <- apply(maxFit, 2, function(x) max(x))

meanFit <- meanFit[2:31,]
meanFit_plot3 <- colMeans(meanFit)
...
distance <- distance[2:31,]
distance_plot3 <- colMeans(distance)
mean_distance <- mean(distance)

plot(seq(1:length(distance_plot3)),distance_plot3, type = 'l', col = "blue", lwd = 2, main = "Mean Edit Distance Sloth 50", xlab = "Generation", ylab = "Average Edit Distance", lty=1)
#plot(seq(1:length(diversity_plot)),diversity_plot, type = 'l', col = "blue", lwd = 2, main = "Mean Diversity No Sloth", xlab = "Generation", ylab = "Diversity", lty=1)
#points(seq(1:100),meanFit_plot, type = 'l', col = "red", lwd = 2, lty=2)
#plot(seq(1:length(maxFit_plot1)),maxFit_plot1, type = 'l', col = "blue", lwd = 2, main = "Max and Mean Fitness Sloth 25", xlab = "Generation", ylab = "Fitness", lty=1)
#points(seq(1:length(meanFit_plot)),meanFit_plot, type = 'l', col = "red", lwd = 2, lty=2)
...
# Distances
plot(seq(1:length(distance_plot1)),distance_plot1, type = 'l', col = "blue", lwd = 2, main = "Mean (30 runs) Edit Distance No Sloth (Blue) vs Sloth 25 (Red) vs Sloth 50 (Green)", xlab = "Generation", ylab = "Average Edit Distance", lty=1)
points(seq(1:length(distance_plot2)),distance_plot2, type = 'l', col = "red", lwd = 2, lty=2)
points(seq(1:length(distance_plot3)),distance_plot3, type = 'l', col = "green", lwd = 2, lty=3)
legend(210, 380, c("No Slotn", "25th Percentile", "50th Percentile"), col = c("blue", "red", "green"), lty = c(1, 2, 3))

# Max fitness
plot(seq(1:length(maxFit_plot1)),maxFit_plot1, type = 'l', col = "blue", lwd = 2, main = "Max Fitness: No Sloth (Blue) vs Sloth 25 (Red) vs Sloth 50 (Green)", xlab = "Generation", ylab = "Max Fitness", lty=1)
points(seq(1:length(maxFit_plot2)),maxFit_plot2, type = 'l', col = "red", lwd = 2, lty=2)
points(seq(1:length(maxFit_plot3)),maxFit_plot3, type = 'l', col = "green", lwd = 2, lty=3)
legend(210, 0.9*max(maxFit_plot1), c("No Slotn", "25th Percentile", "50th Percentile"), col = c("blue", "red", "green"), lty = c(1, 2, 3))

# Mean fitness
plot(seq(1:length(meanFit_plot1)),meanFit_plot1, type = 'l', col = "blue", lwd = 2, main = "mean Fitness: No Sloth (Blue) vs Sloth 25 (Red) vs Sloth 50 (Green)", xlab = "Generation", ylab = "mean Fitness", lty=1)
points(seq(1:length(meanFit_plot2)),meanFit_plot2, type = 'l', col = "red", lwd = 2, lty=2)
points(seq(1:length(meanFit_plot3)),meanFit_plot3, type = 'l', col = "green", lwd = 2, lty=3)
legend(210, 0.9*mean(meanFit_plot1), c("No Slotn", "25th Percentile", "50th Percentile"), col = c("blue", "red", "green"), lty = c(1, 2, 3))
